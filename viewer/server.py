...
def _app_status_readiness(*, live: dict | None, moves: Path | None, is_live_view: bool,
                          ...
                          provider: str, console_errors: int = 0,
    ...
    elif not provider_ready or not moves_writable or not is_live_view or not can_act:
    ...
    ready_for_play = ready_for_smoke and provider.strip().lower() in {"codex", "claude", "openclaw", "scripted"}
    status = "ready" if ready_for_smoke else "degraded"
    health = {
