...
- **Committed tree (`godot/assets/`) = CC0 / public-domain / WorldOS-original ONLY.** CC0 sources:
...
python3 godot/tools/pack_sheet.py --frames <dir>/frames \
...
- **#1064 — `license_check.py` gate** for committed `godot/assets` (add an "owner-generated/Meshy" tier next to CC0).
...
<a name="files"></a>
## 11. File map
- **Runtime:** `godot/project.godot` · `godot/autoload/{Config,SurfaceClient,ImageResolver,FacingResolver,RenderProfile}.gd` · `godot/scenes/{Main,WorldView,CharacterToken,PropActor,InputController,Hud,FxLayer}.{gd,tscn}`
- **Pipeline:** `godot/tools/{meshy_gen,bake_sprites,pack_sheet}.py` + `tools/README.md`
- **Contract/projection:** `godot/ISO-PROJECTION.md` · `docs/roadmap/contracts/*` · `docs/roadmap/WORLDOS-GRAPHICS-ROADMAP.md`
- **Art:** `godot/assets/characters/aubree/{sheet.png,sheet.json}` (CC0 placeholder) · `godot/assets/ATTRIBUTION.md` · finals in `content/worlds/_private/.../images/<scope>/` (gitignored)
