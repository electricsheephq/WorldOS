...
# take the lead, even betray you). Name them with a 4th arg (or $WORLDOS_PLAY_COMPANIONS),
...
#   or:   WORLDOS_PLAY_COMPANIONS="Brogan:fighter:qa/play_companion.txt" ./worldos-play.command
...
# when one is (via the 4th arg or $WORLDOS_PLAY_COMPANIONS). Routing through it keeps the
