...
This is the REPRODUCIBLE source for every PNG under extensions/renderers/godot/assets/. The art is our
...
ISO-PROJECTION.md):
  ...
  Character atlas  (extensions/renderers/godot/assets/characters/aubree/sheet.png)
    cell 128x128
  ...
  Prop atlas  (extensions/renderers/godot/assets/props/pillar/sheet.png)
...
Everything is DETERMINISTIC (no randomness). Re-run to regenerate:
    ...
    python3 extensions/renderers/godot/tools/gen_placeholder_sheet.py
"""
...
# any CWD: `python3 extensions/renderers/godot/tools/gen_placeholder_sheet.py`).
# ---------------------------------------------------------------------------
...
def gen_character_atlas() -> tuple[int, int]:
    ...
    manifest = {
        ...
        "attribution": (
            ...
            "extensions/renderers/godot/tools/gen_placeholder_sheet.py"
        ),
    }
